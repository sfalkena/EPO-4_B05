%Localisation (Appendix C)
function [x_cor,y_cor] = localisation5mic(r12,r13,r14,r15,r23,r24,r25,r34,r35,r45)

m = [460 0 50; 0 0 50; 0 460 50; 460 460 50; 230 460 80]';     % (known) locations of the mics
for i = 1:5
